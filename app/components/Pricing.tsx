...
export const Pricing = () => {
    return (
        <div className='flex flex-col items-center'>
            ...
            <h2 className='flex md:text-6xl text-3xl mt-5 mb-10'>Price & Plans</h2>

            <div className='md:grid md:grid-cols-3 flex px-2 flex-col gap-20'>
                <main className='flex flex-col hover:shadow-2xl shadow-lg'>
                    ...
                    <div className='flex flex-col md:flex-row justify-between px-5 bg-gray-100 py-2'>
                        <div className='my-2'>
                ...
                <main className='flex flex-col hover:shadow-2xl shadow-lg'>
                    ...
                    <div className='flex justify-between px-5 bg-gray-100 py-2 flex-col md:flex-row'>
                        <div className='my-2'>
                            <sup className='mr-1 text-lg'>$</sup>
